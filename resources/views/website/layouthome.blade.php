...
<head>
    ...
    <link href="{{asset('website/homepage/css/styles.css')}}" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase text-color-warning ms-auto py-4 py-lg-0">
                    <li class="nav-item">
 ...
 <br>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start text-black">Copyright &copy; Course ME 2022</div>
    ...
    <!-- Core theme JS-->
    <script src="{{asset('website/homepage/js/scripts.js')}}"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
