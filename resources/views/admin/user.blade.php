...
<h1 class="text-warning" style="padding-left:550px;">Users</h1>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body"> <a class="btn btn-warning text-black position-absolute end-50" href="{{route('add_user')}}">
            ...
            <table class="table table-bordered" id="dataTable" width="50%">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td class="align-left">
                            <a href="{{ route('editUserView', $row->id) }}" class=" btn btn-primary"> <svg
